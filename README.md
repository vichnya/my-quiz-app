...
В директории появятся два ключа - id_rsa и id_rsa.pub, соответствующие приватному и публичному ключу. Помимо них в директории будет и длжен находиться файл authorized_keys.
