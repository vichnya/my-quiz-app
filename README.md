...
Приватный ключ (id_rsa) необходимо записать локально в блокнот или другой текстовый редактор, или непосредственно вставаить в секретные ключи GitHub (подробнее см. 2.2) 

#### 2. Создание репозитория в GitHub и настройка проекта в GitHub
